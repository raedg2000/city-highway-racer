...
export class EntityRenderer {
    drawObstacle(context, obstacle, screenY) {
        if (obstacle.kind === 'pit')
            this.drawPit(context, obstacle.x, screenY, obstacle.width, obstacle.height);
        else
            this.drawAccident(context, obstacle, screenY);
    }
    ...
    drawDamagedVehicle(context, centerX, centerY, vehicle) {
        ...
        if (vehicle.kind === 'motorcycle')
            this.drawDamagedMotorcycle(context, vehicle);
        else if (vehicle.kind === 'truck')
            this.drawDamagedTruck(context, vehicle);
        else if (vehicle.kind === 'bus')
            this.drawDamagedBus(context, vehicle);
        else
            this.drawDamagedCarLikeVehicle(context, vehicle);
